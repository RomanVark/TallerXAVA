...
En facturacion-labels_es.properties:
facturacion=Tu aplicación
facturacion[description]=Tu aplicación hace esto y lo otro

En facturacion-messages_en.properties:
