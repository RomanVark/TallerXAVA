...
- Crea la clase de la acción en el paquete `com.Roman.facturacion.acciones`, normalmente extendiendo `ViewBaseAction`
...
<controlador nombre="TuPrimeraEntidad">
    ...
    <accion nombre="mostrarImporte" modo="detail"
        clase="com.Roman.facturacion.acciones.MostrarImporte"/>
</controlador>
```

```java
package com.Roman.facturacion.acciones;
...
- ✅ Coloca las clases de acción en `com.Roman.facturacion.acciones`
...
```java
package com.Roman.facturacion.pruebas;
...
- Crea un paquete `cuadrosmando` (ej. `com.Roman.facturacion.cuadrosmando`) y coloca la clase `CuadroMando` y sus clases auxiliares en él.
